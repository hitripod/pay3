...
import { Address as AddressType } from "viem/chains";
...
import useConditionalEthProfile from "~~/hooks/useConditionalEthProfile";
...
export const Address = ({
  ...
  const { data: profile } = useConditionalEthProfile(address);
  ...
  if (checkSumAddress && !isAddress(checkSumAddress)) {
